Maven local repository is the repository of local machine.This repository downloads the dependencies(jar,war files) frome remote servers and store into local machine repository.
